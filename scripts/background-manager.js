...
const BackgroundManager = {
    ...
    init: function() {
        ...
        // 粒子动画控制
        this.enableParticles = document.getElementById('enable-particles');
    ...
    resetPreview: function() {
        ...
        if (this.enableParticles) {
            this.enableParticles.checked = localStorage.getItem('enableBackgroundParticles') === 'true';
        }
    ...
    applyBackground: function() {
        ...
        // 保存粒子动画设置
        this.currentBackground.enableParticles = this.enableParticles ? this.enableParticles.checked : false;
    ...
    applyBackgroundToDOM: function() {
        try {
            ...
            if (this.currentBackground.enableParticles) {
                // 启用粒子动画
                if (bgAnimation) {
                    bgAnimation.style.display = 'block';
                } else {
                    // 如果不存在粒子动画，则初始化它
                    import('./background-animation.js').then(module => {
                        const BackgroundAnimation = module.default;
                        // 使用强制初始化参数
                        BackgroundAnimation.init(true);
                    });
                }
            } else {
                // 禁用粒子动画
    ...
    saveBackgroundToStorage: function() {
        try {
            ...
            localStorage.setItem('enableBackgroundParticles', this.currentBackground.enableParticles);
    ...
    loadBackgroundFromStorage: function() {
        try {
            ...
            const usingCustomBg = localStorage.getItem('usingCustomBackground');
            const enableParticles = localStorage.getItem('enableBackgroundParticles') === 'true';
            ...
            this.currentBackground.enableParticles = enableParticles;
    ...
    resetBackground: async function(skipConfirm) {
        ...
        try {
            ...
            localStorage.removeItem('enableBackgroundParticles');
